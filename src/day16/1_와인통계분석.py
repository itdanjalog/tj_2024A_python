...
회귀모형수식 = 'quality ~ fixed_acidity + volatile_acidity + citric_acid + \
            residual_sugar + chlorides + free_sulfur_dioxide + \
            total_sulfur_dioxide + density + pH + sulphates + alcohol'  # 종속변수와 독립변수를 정의 #
# 가설 : 알콜 수치에 따라 등급 확인
# 독립변수(원인/연속성) 알콜
# 종속변수(결과/연속성) 등급
...
sample1 = sample1[0:5][:]
sample1_predict = 선형회귀모델결과.predict(sample1)
...
sample2_predict = 선형회귀모델결과.predict(sample2)

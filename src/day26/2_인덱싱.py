...
# 문제1] 첫번째 스칼라(요소) 인덱싱
# 문제2] 뒤에서 부터 2번째 스칼라(요소) 인덱싱
# 문제3] 앞에서 3개 요소 슬라이싱 하기
# 문제4] 뒤에서 4개 요소 슬라이싱 하기

# 2. 행렬
matrix = tf.constant( [ [1,2,3],[4,5,6],[7,8,9]])
# 문제1] 첫번째 행 , 두번째 열 요소 인덱싱
# 문제2] 세번째 행 , 첫번째 열 요소 인덱싱
# 문제3] 첫번째 행 전체 슬라이싱
# 문제4] 두번째 열 전체 슬라이싱

# 3. 3차원텐서
vector = tf.constant( [   [[1,2],[3,4]] , [[5,6],[7,8]]   ] )
# 문제1] 가장 첫번째 요소 인덱싱 , 예] 1
# 문제2] 가장 마지막 요소 인덱싱 , 예] 8
# 문제3] 첫번째 행렬 슬라이싱
# 문제4] 두번째 행렬의 첫번째 행 슬라이싱
